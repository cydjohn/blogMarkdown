---
title: 如何证明C++运行速度比python快
date: 2020-08-12 00:18:58
tags: python
---

给别人上课的时候突然有了这个问题，然后想了个证明方法，感觉还挺直观的，这里记录下。方法就是用两种语言分别写两个冒泡排序，然后从文件中读取随机数，排序之后比较程序运行时间。选择用冒泡排序是因为O（n^2)复杂度，可以拉长程序运行时间，结果比较更直观， 快排结果不太理想。
